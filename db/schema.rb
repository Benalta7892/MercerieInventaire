...
ActiveRecord::Schema[7.1].define(version: 2026_01_24_115810) do
  ...
  create_table "fournitures", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_fournitures_on_category_id"
  ...
  create_table "liste_achats", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_liste_achats_on_user_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["admin"], name: "index_users_on_admin", unique: true, where: "(admin = true)"
